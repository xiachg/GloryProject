<GameFile>
  <PropertyGroup Name="ChargeAni" Type="Node" ID="e12ca553-6523-4af6-b46a-532a786f1373" Version="3.10.0.0" />
  <Content ctype="GameProjectContent">
    <Content>
      <Animation Duration="4" Speed="0.1667">
        <Timeline ActionTag="-1869904392" Property="FileData">
          <TextureFrame FrameIndex="0" Tween="False">
            <TextureFile Type="PlistSubImage" Path="ani_charge_0.png" Plist="plaza/plaza.plist" />
          </TextureFrame>
          <TextureFrame FrameIndex="1" Tween="False">
            <TextureFile Type="PlistSubImage" Path="ani_charge_1.png" Plist="plaza/plaza.plist" />
          </TextureFrame>
          <TextureFrame FrameIndex="2" Tween="False">
            <TextureFile Type="PlistSubImage" Path="ani_charge_2.png" Plist="plaza/plaza.plist" />
          </TextureFrame>
          <TextureFrame FrameIndex="3" Tween="False">
            <TextureFile Type="PlistSubImage" Path="ani_charge_3.png" Plist="plaza/plaza.plist" />
          </TextureFrame>
          <TextureFrame FrameIndex="4" Tween="False">
            <TextureFile Type="PlistSubImage" Path="ani_charge_4.png" Plist="plaza/plaza.plist" />
          </TextureFrame>
        </Timeline>
        <Timeline ActionTag="-1869904392" Property="BlendFunc">
