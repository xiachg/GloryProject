...
cmd.IDI_FREE		=			99									--空闲时间
cmd.IDI_PLACE_JETTON		=	100									--下注时间
cmd.IDI_DISPATCH_CARD	=		301									--发牌时间
--区域索引
cmd.ID_TIAN_MEN					= 1									--天
cmd.ID_DI_MEN					= 2									--地
cmd.ID_XUAN_MEN					= 3									--玄
...
--服务器命令结构
cmd.SUB_S_GAME_FREE				= 107								--游戏空闲
cmd.SUB_S_GAME_START			= 108								--游戏开始							
cmd.SUB_S_PLACE_JETTON			= 109								--用户下注	
cmd.SUB_S_GAME_END				= 110								--游戏结束	
cmd.SUB_S_APPLY_BANKER			= 111								--申请庄家	
cmd.SUB_S_CHANGE_BANKER			= 112								--切换庄家
cmd.SUB_S_CHANGE_USER_SCORE		= 113								--更新积分			
cmd.SUB_S_SEND_RECORD			= 114								--游戏记录
cmd.SUB_S_PLACE_JETTON_FAIL		= 115								--下注失败
cmd.SUB_S_CANCEL_BANKER			= 116								--取消申请

cmd.SUB_S_ADVANCE_OPENCARD		= 137								--提前开牌
cmd.SUB_S_TIME_STATUS = 121

cmd.SUB_S_SUPERROB_BANKER		= 114+8								--超级抢庄
cmd.SUB_S_CURSUPERROB_LEAVE		= 115+8								--超级抢庄玩家离开
...
------客户端命令结构----
cmd.SUB_C_PLACE_JETTON			= 1+8						--用户下注
cmd.SUB_C_APPLY_BANKER			= 2+8						--申请庄家
cmd.SUB_C_CANCEL_BANKER			= 3+8						--取消申请
cmd.SUB_C_CONTINUE_CARD			= 4+8						--继续发牌

cmd.SUB_C_SUPERROB_BANKER		= 7+8						--超级抢庄
cmd.SUB_C_OCCUPYSEAT			= 8+8						--占位
cmd.SUB_C_QUIT_OCCUPYSEAT		= 9+8						--退出占位
