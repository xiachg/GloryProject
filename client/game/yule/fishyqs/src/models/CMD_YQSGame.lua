...
-- 特殊鱼
cmd.FishType_JinLong        = 18              -- 金龙
cmd.FishType_LvQianNianGui        = 19              -- 绿色千年龟摇钱树
cmd.FishType_YinQianNianGui        = 20              -- 银色千年龟摇钱树
cmd.FishType_JinQianNianGui        = 21              -- 金色千年龟摇钱树
cmd.FishType_PiaoLiuPing        = 22              -- 漂流瓶
cmd.FishType_TuLongDao        = 23              -- 屠龙刀
cmd.FishType_HuoShan        = 24              -- 火山
cmd.FishType_BaoXiang        = 25              -- 宝箱
cmd.FishType_YuanBao        = 26              -- 元宝
...
cmd.GameScene = 
{
  ...
  {k="lPlayFishCount",t="int",l={8,8,8,8,8,8,8,8,8,8,8,8,8,8,8,8,8,8,8,8,8,8,8,8,8,8,8}},
  {k="nMultipleValue",t="int",l={cmd.Multiple_Max}},
