...
function RankingListLayer:onEnterTransitionFinish()
	if 0 == #self._rankList then
		...
		appdf.onHttpJsionTable(yl.HTTP_URL .. "/WS/PhoneRank.ashx","GET","action=getscorerank&pageindex=1&pagesize=10&userid="..GlobalUserItem.dwUserID,function(jstable,jsdata)
