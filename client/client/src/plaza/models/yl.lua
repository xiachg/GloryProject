...
--测试
yl.LOGONSERVER							= "118.178.237.80" --@login_ip
-- 登陆地址列表
yl.SERVER_LIST = 
{
    "118.178.237.80", --@login_ip
...
--http请求链接地址 
yl.HTTP_URL								= "http://118.178.237.80:8011" --@http_url
...
yl.SocialShare =
{
	title 								= "浙江润土科技", --@share_title_social
...
yl.AliPay = 
{
	...
	NotifyURL							= yl.HTTP_URL .. "/Pay/ZFB/notify_url.aspx",
	-- ios支付宝Schemes
	AliSchemes							= "RTKJAliPay", --@alipay_schemes_zfb
}
